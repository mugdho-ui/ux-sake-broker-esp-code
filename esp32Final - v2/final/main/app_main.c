...
// #include "config.h"
// #include "led_config.h"  // LED control header add করা হলো
...
// // 2️⃣ Queue Handle (অন্যান্য queue handles এর সাথে add করো)
// static QueueHandle_t randomSugarQueue;

// // 3️⃣ Task Handle (অন্যান্য task handles এর সাথে add করো)
...
// // 4️⃣ Random Sugar Task Function
// // ============ Random Sugar Task ============
// static void random_sugar_task(void *param) {
//     RandomSugarData data;
    
//     ESP_LOGI(TAG, "🎲 Random Sugar Task Started!");
    
//     for (;;) {
//         // Generate random number between 20 and 40
//         uint32_t random_val = esp_random();
        
//         // Formula: 20.0 + (random % 2001) / 100.0
//         // This gives us: 20.00, 20.01, 20.02, ... 39.99, 40.00
//         data.value = 20.0f + ((float)(random_val % 2001) / 100.0f);
        
//         ESP_LOGI(TAG, "🎲 Random Sugar - Generated: %.2f", data.value);
...
//     // LED initialize করা (সবার প্রথমে)
//     led_init();
//     led_off(); // শুরুতে LED OFF রাখা
...
//         // WiFi connecting শুরু - LED blink করানো
//         led_blink_start();
//         ESP_LOGI(TAG, "🔄 Connecting to Wi-Fi... (LED Blinking)");
        
//         if (wifi_manager_connect() == ESP_OK) {
//             // WiFi connected - LED constant ON করা
//             led_blink_stop();
//             led_on();
//             ESP_LOGI(TAG, "✅ Connected to Wi-Fi (LED ON)");
//         } else {
//             // Connection failed - LED blink রাখা
...
//             // Portal mode এ LED blink থাকবে
//             return;
//         }
//     } else {
//         ESP_LOGI(TAG, "⚙️ No credentials, starting portal...");
//         led_blink_start(); // Portal mode এও blink করবে
//         wifi_manager_start_portal();
//         ESP_LOGI(TAG, "📱 Connect to 'ESP32-Setup' at 192.168.4.1");
//         return;
//     }

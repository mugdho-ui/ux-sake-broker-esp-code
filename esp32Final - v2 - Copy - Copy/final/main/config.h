...
// // ===================== THRESHOLDS ====================
// #define DS18B20_TEMP_THRESHOLD 30.0f
// #define SONAR1_DISTANCE_THRESHOLD 12.0f
#pragma once
#include "esp_err.h"
#include "mqtt_client.h"
...
// ===================== THRESHOLDS ====================
// Default values (used at startup, can be changed via MQTT)
#define DEFAULT_DS18B20_TEMP_THRESHOLD 30.0f
#define DEFAULT_SONAR1_DISTANCE_THRESHOLD 12.0f

// Keep old defines for backward compatibility
#define DS18B20_TEMP_THRESHOLD DEFAULT_DS18B20_TEMP_THRESHOLD
#define SONAR1_DISTANCE_THRESHOLD DEFAULT_SONAR1_DISTANCE_THRESHOLD
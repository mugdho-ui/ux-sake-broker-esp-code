...
//     Serial.println("⚠️ Check: 1) Broker address  2) Port  3) Firewall");
//   }
...
//     // Try with clean session
//     if (mqtt.connect(MQTT_CLIENT_ID, MQTT_USER, MQTT_PASS, NULL, 0, 0, NULL, true)) {
//       Serial.println("✅ Connected!");
//       return;
//     } else {
//       int rc = mqtt.state();
...
//     Serial.println("   1. Verify broker is online (ping bdtmp.ultra-x.jp)");
//     Serial.println("   2. Check port 1883 is open");
//     Serial.println("   3. Verify credentials: admin / StrongPassword123");
//     Serial.println("   4. Try broker IP instead of hostname");
//   }
// }
